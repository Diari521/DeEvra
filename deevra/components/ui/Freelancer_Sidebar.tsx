...
export default function Freelancer_Sidebar() {
  ...
  const navigation = [
    ...
    { label: "Find Work", icon: FileText, children: ["All Jobs", "Saved", "Suggested"] },
    ...
    { label: "Wallet", icon: Wallet, children: ["Overview", "Withdraw", "History"] },
  ...
  const glassCardMatch =  "bg-white/80 dark:bg-gray-800/40 backdrop-blur-md border border-white/20 dark:border-gray-700 shadow-md transition-all duration-300";
  return (
    <>
      {/* Mobile menu button */}
      <button
        className="fixed top-7 left-4 z-[60] md:hidden"
      ...
      {/* Desktop Sidebar */}
      <div className="hidden md:block fixed z-40 left-10 top-28 bottom-6">
